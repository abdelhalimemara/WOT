...
class PrimarySearchAppBar extends React.Component {
  ...
  handleNotificationsMenuClose = () => {
    ...
    this.handleNotificationsMenuClose();
  };
  ...
  render() {
    const { anchorEl, anchorElNotifications, mobileMoreAnchorEl } = this.state;
    ...
    const renderNotificationMenu = (
      ...
      >
        <MenuItem onClick={this.handleNotificationsMenuClose}>Notification 1</MenuItem>
        <MenuItem onClick={this.handleNotificationsMenuClose}>See All</MenuItem>
      </Menu>
    );
        ...
        <AppBar position="static">
          <Toolbar>
            ...
            <div className={classes.sectionDesktop}>
              ...
              <IconButton
                aria-owns={isNotificationsMenuOpen ? 'material-appbar' : undefined}
                aria-haspopup="true"
